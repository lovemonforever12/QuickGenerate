 ...
 *
 */
public final class ReadEditionUtil {
    /**
     * 读取apk
     * @param apkUrl
     * @return
     */
    public static Map<String,String> readAPK(File apkUrl){
        ZipFile zipFile;
     ...
     * 读取ipa
     */
    public static Map<String,String> readIPA(File file){
        Map<String,String> map = new HashMap<String,String>();
        try {
            ...
            while ((ze = zipIns.getNextEntry()) != null) {
                if (!ze.isDirectory()) {
                    ...
                    if (null != name && name.toLowerCase().contains("payload/utrust.app/info.plist")) {

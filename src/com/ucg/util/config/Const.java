...
public interface Const {
	...
	String AfterDocBaseDir = "upload";

	String UploadBasePath = "E:/Program Files/apache-tomcat-6.0.37/webapps/jindouyun";

	String ThumbnailDirName = "thumbnail";

	Boolean NeedThumbnail = true;

	Integer ScaleWidth = 80;

	Integer ScaleHeight = 80;

	String foreServerUrl = "http://spreadingwind.com";

	String foreServerFileRequest = "/product/getPlainImage/";
